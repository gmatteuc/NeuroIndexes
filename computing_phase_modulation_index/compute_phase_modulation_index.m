...
% component and calls the function "get_phase_modulation_index" on it 
...
[ F1z, F1F0 , fh ] = get_phase_modulation_index( psth, psth_dur, TF_target, 1 );
sgtitle('Example of modulation index calculation')

% print as a jpg
saveas(fh,['computing_phase_modulation_index','.jpg']) 
% print in Illustrator friendly vector format
print(fh,'-depsc','-painters',['computing_phase_modulation_index','.eps']) %#ok<PRTPT>