...
% create a violin plot with optional boxplot and scatter plot features.
%   inputadata: struct containing the distributions to plot
%   inputpars: struct containing various parameters for plotting
%   inputaxh: axis handle where the plot is drawn
% --------------------------------
