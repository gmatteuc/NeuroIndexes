...
% reorder it with hierarchical clustering using "compute_median_diff_surprises",
% "reorder_compmat", "plot_surprise_matrix" and "plot_dendrogram" functions.
% -------------------------------------------------------------------------
...
% print as a jpg
saveas(fh,['comparing_medians_of_distributions','.jpg']) 
% print in Illustrator friendly vector format
print(fh,'-depsc','-painters',['comparing_medians_of_distributions','.eps']) %#ok<PRTPT>